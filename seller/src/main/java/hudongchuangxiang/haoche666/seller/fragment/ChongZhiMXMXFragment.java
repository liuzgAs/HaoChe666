...
import hudongchuangxiang.haoche666.seller.viewholder.ChongZhiMXViewHolder;
 ...
 */
public class ChongZhiMXMXFragment extends ZjbBaseFragment implements SwipeRefreshLayout.OnRefreshListener {
    ...
    private void initRecycle() {
        ...
        recyclerView.setRefreshingColorResources(R.color.basic_color01);
        recyclerView.setAdapterWithProgress(adapter = new RecyclerArrayAdapter<Integer>(getActivity()) {
            @Override
            public BaseViewHolder OnCreateViewHolder(ViewGroup parent, int viewType) {
                int layout = R.layout.item_xiao_fei_mx;
                return new ChongZhiMXViewHolder(parent, layout);
            }
