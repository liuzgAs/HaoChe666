...
import hudongchuangxiang.haoche666.seller.fragment.ChongZhiGZFragment;
import hudongchuangxiang.haoche666.seller.fragment.ChongZhiMXMXFragment;
...
public class ChongZhiActivity extends ZjbBaseActivity implements View.OnClickListener {
    ...
    class MyPagerAdapter extends FragmentPagerAdapter {
        ...
        public Fragment getItem(int position) {
            switch (position) {
                case 0:
                    return new ChongZhiMXMXFragment();
                case 1:
