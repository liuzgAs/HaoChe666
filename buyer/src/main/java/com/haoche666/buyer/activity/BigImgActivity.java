...
import com.haoche666.buyer.photoview.HackyViewPager;
...
public class BigImgActivity extends ZjbBaseNotLeftActivity {
    ...
    protected void initIntent() {
        ...
        BigImgList bigImgList = (BigImgList) intent.getSerializableExtra(Constant.IntentKey.BIG_IMG);
        imgList = bigImgList.getImgList();
        mPosition = intent.getIntExtra(Constant.IntentKey.BIG_IMG_POSITION, 0);
        des = intent.getStringExtra(Constant.IntentKey.VALUE);
    }
