...
import com.haoche666.buyer.viewholder.MyBaseViewHolder;
...
public class WoMaiDeCheActivity extends ZjbBaseActivity implements View.OnClickListener, SwipeRefreshLayout.OnRefreshListener {
    ...
    private void initRecycler() {
        ...
        recyclerView.setAdapterWithProgress(adapter = new RecyclerArrayAdapter<Integer>(WoMaiDeCheActivity.this) {
            @Override
