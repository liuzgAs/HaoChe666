...
//    private View mFloatView;
    ...
    private float mDefaultWaterLevelRatioF = 0.9f;
    private float mDefaultWaterLevelRatioT = 0.9f;
    //波浪大小振幅 amplitudeRatio
    private float mDefaultAmplitudeRatioF = 0.06f;
    private float mDefaultAmplitudeRatioT = 0.04f;
    //floatView 旋转调整角
    ...
    public HeaderWaveHelper(HeaderWaveView HeaderWaveView, int behindWaveColor, int frontWaveColor) {
...
//        mFloatView = view;
    ...
    private void initAnimation() {
        ...
        mAmplitudeAnim.setDuration(2000);
